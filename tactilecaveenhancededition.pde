/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/26875*@* */
/* !do not delete the line above, required for linking your tweak if you upload again */
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//TTTTTTTT    AA     CCCCCCCC  TTTTTTTT  IIIIIIII  LL        EEEEEEEE            CCCCCCCC      AA     VV      VV  EEEEEEEE  !!  !!  //                                                                                                                                   
//   TT      AAAA    CC           TT        II     LL        EE                  CC           AAAA     VV    VV   EE        !!  !!  //
//   TT     AA  AA   CC           TT        II     LL        EEEEEEEE            CC          AA  AA     VV  VV    EEEEEEEE  !!  !!  //
//   TT    AAAAAAAA  CC           TT        II     LL        EE                  CC         AAAAAAAA     VVVV     EE                //
//   TT   AA      AA CCCCCCCC     TT     IIIIIIII  LLLLLLLL  EEEEEEEE            CCCCCCCC  AA      AA     VV      EEEEEEEE  !!  !!  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void setup()
{
  ...
  pathToData = "/home/daniel/Documents/code/processing/tactilecaveenhancededition/data/";
  //FOR THE SPLASH SCREEN
  splash = loadImage(pathToData + "SPLASH.png");

 
  //LOAD THE INSTRUCTIONS
  instructions = loadImage(pathToData + "INSTRUCTIONS.png");
 
  //Load sprites
  PCsprite = loadImage(pathToData + "PCsprite.png");
  //Load lightrays
  lightrays = loadImage(pathToData + "lightrays.png");
  //Load walls
  walls = loadImage(pathToData + "walls.png");
  ...
  //BGM1 -- plays first background song
   ...
   bgm1 = minim.loadFile(pathToData + "bgm1.mp3", 2048);
   bgm1.play();
   bgm1.loop();
  ...
  //load font
  font = loadFont(pathToData + "Arial-Black-48.vlw");
  ...
  if (state == 2)  //play state
  {
    ...
    if (collected_rays == 9)
    {
      ...
      level[0][0] = level[0][1] = level[0][2] = level[0][3] = level[0][4] = level[0][5] = level[0][6] = level[0][7] = level[0][8] = level[0][9] = level[0][10] = level[0][11] = level[0][12] =
        ...
        level[12][9] = level[12][10] = level[12][11] = level[12][12] =
    ...
    if (collected_rays == 45)
    {
      loop();
      alive = true;
      //BGM2 -- play a new song in level 3 ---seems to not work right b/c 1st song is a lot longer than 2nd song & songs play at the same time
      /*Minim minim;
       AudioPlayer bgm2;
       minim = new Minim(this);
       bgm2 = minim.loadFile("bgm2.mp3", 2048);
       bgm2.play();*/
